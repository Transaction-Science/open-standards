...
> *You are looking at **face 1 of 3** — the value face. The other two are linked at the bottom.*
...
- Smart Byte: `byte.transaction.science` / [`../smart-byte/`](./) — *Smart Byte Substrate: A Treatise* in [`spec/`](./spec/).
- EOC: `eoc.transaction.science` / [`../eoc/`](../eoc/) — the four-stage pipeline and the wire protocol in `eoc/spec/`.
