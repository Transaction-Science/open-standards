...
- **Status:** Document stack v1.2 (May 2026). Specification published (`ARL.md`, `ARL-S.md`, `LEXICON.md`); standalone reference impl begun — `arl-rs/` ships `arl-core` (four-axis claim model + cross-axis gates + lexicon enforcement, 22 tests, no runtime coupling).
