...
- **Status:** Document stack v1.2 (May 2026). Specification published (`ARL.md`, `ARL-S.md`, `LEXICON.md`); standalone reference impl in `arl-rs/` — `arl-core` (four-axis claim model + cross-axis gates + lexicon enforcement) and `arl-sandbox` (ARL-S session model + tier/telemetry gates + Ed25519-over-JCS + SHA-256 attestation). 38 tests, no runtime coupling.
