...
`arl-rs/` is **51 tests, 0 failures**, depends on nothing but `arl-core` + neutral crypto crates. No playground, multi-node sandbox, edge tier, non-NVIDIA accelerator telemetry, or continuous-evaluation framework ships in v1.2.
