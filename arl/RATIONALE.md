...
**Energy is a first-order constraint.** The electricity and cooling cost of training and inference has become a material constraint on deployment, and it is invisible in a headline capability score. A readiness measure that omits joules omits the part of the system that the physical world actually bills for.
